...
python3 train_nerd.py --datadir /esat/topaz/gkouros/datasets/nerf/$NAME --basedir logs/$NAME --expname exp-$EXP --gpu $CUDA_VISIBLE_DEVICES --config configs/nerd/nerf_blender.txt --spherify
